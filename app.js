...
// POST http://localhost:10000/api/v1/auth/send-otp
// Required: email
// Returns: Success message
const SEND_OTP_API = `${BASE_URL}/auth/send-otp`

// Verify OTP and Reset Password
// POST http://localhost:10000/api/v1/auth/verify-otp-email
...
// GET http://localhost:10000/api/v1/users
// Headers: Authorization: Bearer {admin_token}
// Returns: List of all users
const GET_ALL_USERS_API = `${BASE_URL}/users`

// Get User by ID
// GET http://localhost:10000/api/v1/users/:userId
// Headers: Authorization: Bearer {token}
// Returns: User data
const GET_USER_BY_ID_API = `${BASE_URL}/users/:userId`

// Update User
// PUT http://localhost:10000/api/v1/users/:userId
...
// DELETE http://localhost:10000/api/v1/users/:userId
// Headers: Authorization: Bearer {admin_token}
// Returns: Success message
const DELETE_USER_API = `${BASE_URL}/users/:userId`

// Upload User Profile Image
// POST http://localhost:10000/api/v1/users/upload-profile/:userId
...
// Apply for Leave
// POST http://localhost:10000/api/v1/leave/apply-leave
...
// GET http://localhost:10000/api/v1/leave/getAllLeaves
// Headers: Authorization: Bearer {admin_token}
// Returns: All leaves and pending leaves
const GET_ALL_LEAVES_API = `${BASE_URL}/leave/getAllLeaves`

// Update Leave Status (Admin only)
// PUT http://localhost:10000/api/v1/leave/update-leave/:userId
...
// GET http://localhost:10000/api/v1/leave/leave-stats
// Headers: Authorization: Bearer {admin_token}
